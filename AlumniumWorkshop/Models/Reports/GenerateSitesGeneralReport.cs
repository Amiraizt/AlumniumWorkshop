...
{
    public class GenerateSitesGeneralReport
    {
        ...
        SitesGeneralReportModel _model = new SitesGeneralReportModel();

        public byte[] PrepareReport(SitesGeneralReportModel model)
        {
            _model = model;
        ...
        private void ReportBody()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("عددالامتار", boldFont));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
            _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            _pdfCell.BackgroundColor = lightgrey;
            ...
            int serialNumber = 1;
            foreach (var item in _model.Sites)
            {

                _pdfCell = new PdfPCell(new Phrase(item.SiteName, normalFont));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                _pdfCell.BackgroundColor = BaseColor.WHITE;
                ...
                _pdfCell = new PdfPCell(new Phrase(item.SiteOwnerName, normalFont));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                _pdfCell.BackgroundColor = BaseColor.WHITE;
                ...
                _pdfCell = new PdfPCell(new Phrase(item.MetersNumber, normalFont));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                _pdfCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportFooter()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase(_model.TotalPrice, boldFontsmall));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
            _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            _pdfCell.BackgroundColor = gray;
