...
{
    public class GenerateStoreReport
    {
        ...
        Font _fontStyle;
        PdfPTable _pdfTable1 = new PdfPTable(2);
        PdfPTable _pdfTable2 = new PdfPTable(2);
        ...
        public byte[] PrepareReport(ItemsConsumingReportModel model)
        {
            ...
            _doc.Open();
            _pdfTable1.SetWidths(new float[] { 50f, 50f });
        ...
        private void ReportBody()
        {
            ...
            foreach (var item in _model.ConsumedItems)
            {
                ...
                //_pdfCell = new PdfPCell(new Phrase(item.TotalPrice.ToString() + " " + "SAR", normalFont));
                //_pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                //_pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                //_pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                //_pdfCell.BackgroundColor = BaseColor.WHITE;
