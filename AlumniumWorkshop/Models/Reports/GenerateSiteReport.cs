...
namespace AlumniumWorkshop.Models.Reports
{
    public class GenerateSiteReport
    {
        ...
        PdfPTable _itemsTable = new PdfPTable(5)
        {
        ...
        public byte[] PrepareReport(SiteReportModel model)
        {
            ...
            _itemsTable.SetWidths(new float[] { 80f, 80f, 80f, 80f,80f });
        ...
        private void ReportHeader()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("اسم صاحب الموقع :" + " " + _model.SiteOwnerName, _fontStyle));
            _pdfCell.Colspan = _totalColumn;
        ...
        private void ReportBody()
        {
           ...
           _pdfCell = new PdfPCell(new Phrase(_model.SiteOwnerName, normalFont));
            ...
            _pdfCell = new PdfPCell(new Phrase(_model.CurrentTotalPrice + " " + "SAR", normalFont));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
            _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            _pdfCell.BackgroundColor = BaseColor.WHITE;
            ...
            _pdfCell = new PdfPCell(new Phrase("تاريخ الاستخدام", boldFont));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
            _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            _pdfCell.BackgroundColor = lightgrey;
            ...
            foreach (var item in _model.Items)
            {
                ...
                _pdfCell = new PdfPCell(new Phrase(item.UsedQuantityDate, normalFont));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                _pdfCell.BackgroundColor = BaseColor.WHITE;
                ...
                _pdfCell = new PdfPCell(new Phrase(item.Price.ToString() + " " + "SAR", normalFont));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_CENTER;
                _pdfCell.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                _pdfCell.BackgroundColor = BaseColor.WHITE;
